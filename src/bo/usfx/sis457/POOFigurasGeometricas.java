        ...
        switch (opcion) {
            ...
            case 3:
                ...
                /* Se instancia un objeto de la Clase Triangulo y a la vez se inicilaizan los valores
                   de sus propiedades "B" y "H" a través del método Constructor (Triangulo). */
                limpiarConsola();
                System.out.println("+==================================================+");
                ...
                break;
                case 5:
                      /* Se instancia un objeto de la Clase Pentagono y a la vez se inicilaizan los valores
                   de sus propiedades "Lado" a través del método Constructor (Pentagono). */
                limpiarConsola();
                System.out.println("+==================================================+");
                ...
                System.out.print("Introduzca el valor de la Altura: ");
                double alturaa = entradaTeclado.nextDouble();
                Trapecio trapecio = new Trapecio(basemayor, basemenor , alturaa);
                System.out.println("El Area del Trapecio es: " + trapecio.getArea());
                System.out.println("El Perimetro del Trapecioo es: " + trapecio.getPerimetro());
                break;
